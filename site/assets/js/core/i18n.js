...
export var UI = {
  ja: {
    ...
    nav_agencies: "事務所", nav_stats: "統計",
    agency_unknown: "事務所不明", agency_count: "事務所",
    sort_label: "並び替え",
    ...
    f_series: "シリーズ", f_duration: "時間", f_director: "監督",     f_rating: "評価", f_synopsis: "あらすじ", f_samples: "スクリーンショット",
    f_bio: "プロフィール",
    flt_t: "タグ", flt_m: "メーカー / レーベル", flt_s: "シリーズ", flt_d: "監督",
    pending_title: "（タイトル未取得）", badge_incomplete: "データ不足",
    filter_title: "絞り込み", filter_apply: "適用", filter_reset: "クリア",
    filter_keyword: "キーワード", filter_actress: "女優", filter_tag: "タグ",
    filter_maker: "メーカー", filter_series: "シリーズ",
    group_by: "グループ化", g_none: "なし", g_year: "年度", g_maker: "メーカー",
    hover_src: "ホバーで出典アイコン", src_on: "出典アイコン表示中",
    open_filter: "絞り込み", unknown: "不明",
  ...
  zh: {
    ...
    nav_agencies: "事务所", nav_stats: "统计",
    agency_unknown: "事务所未知", agency_count: "家事务所",
    sort_label: "排序",
    ...
    f_series: "系列", f_duration: "时长", f_director: "导演", f_rating: "评分", f_synopsis: "剧情简介", f_samples: "预览图",
    f_bio: "个人简介",
    flt_t: "标签", flt_m: "片商 / 厂牌", flt_s: "系列", flt_d: "导演",
    pending_title: "（片名待抓取）", badge_incomplete: "资料不全",
    filter_title: "筛选", filter_apply: "应用", filter_reset: "清空",
    filter_keyword: "关键词", filter_actress: "女优", filter_tag: "标签",
    filter_maker: "片商", filter_series: "系列",
    group_by: "分组", g_none: "不分组", g_year: "按年份", g_maker: "按片商",
    hover_src: "悬停显示来源图标", src_on: "来源图标已开启",
    open_filter: "筛选", unknown: "未知",
    empty_works: "没有匹配的作品。",
    err_work: "未找到作品：", err_actress: "未找到女优：", err_page: "未知页面：",
